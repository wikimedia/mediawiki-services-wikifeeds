 ...
 * @param {!number} year the year the event first happened. A negative number indicates the event
 ...
 * @return {!number} number of years between eventB and eventA ( yearB - yearA ).
 */
 ...
 * @param {boolean} [sendResponse] whether to send the response
 * @return {Promise}
 */
