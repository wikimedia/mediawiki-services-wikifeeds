...
const getFundraisingAnnouncementText = (countryConfig) => `To all our readers,<br/><br/>Please don't scroll past this. We apologise for interrupting your reading today, and we'll be direct: We request you to sustain Wikipedia's independence. 98% of our readers don't donate; they simply keep reading. If you are an exceptional reader who has already donated, we sincerely thank you. <b>If you donate just ${countryConfig.currency}${countryConfig.coffee} today, Wikipedia could keep growing for years.</b> Most people donate because Wikipedia is so useful. We request you: please don’t scroll away. If Wikipedia has given you ${countryConfig.currency}${countryConfig.coffee} worth of knowledge, kindly take a minute to donate. Show the world that access to reliable, neutral information matters to you. Thank you.`;
...
const androidV2FundraisingAnnouncement = (code, countryConfig, campaign) => {
    return Object.assign({}, baseAnnouncement(campaign), {
        ...
        action: {
            title: 'DONATE NOW',
            url: `https://donate.wikimedia.org/?uselang=en&appeal=JimmyQuote&utm_medium=WikipediaApp&utm_campaign=Android&utm_source=app_2022_enIN_Android_control&country=${code.toUpperCase()}`
        }
    });
};
...
const iosV2FundraisingAnnouncement = (code, countryConfig, campaign) => {
    return Object.assign({}, baseAnnouncement(campaign), {
        ...
        action: {
            title: 'DONATE NOW',
            url: `https://donate.wikimedia.org/?uselang=en&appeal=JimmyQuote&utm_medium=WikipediaApp&utm_campaign=iOS&utm_source=app_2021_6C_iOS_control&monthlyconvert=Default&country=${code.toUpperCase()}`
        }
    });
};
