...
const getFundraisingAnnouncementText = (countryConfig) => `To all our readers in ${countryConfig.country},<br/><br/>The Wikimedia projects, which include Wikipedia and 12 sister sites, are something special. Like a library or a public park where we can all go to learn—a refuge for the mind. Each year, we ask readers to pitch in whatever they can comfortably afford to make access to free knowledge possible. Most people don't give, and that's totally ok. That's the beauty of it—the work and donations of a few make something beautiful possible for everyone in the world. We are financially secure because each year, enough people choose to donate ${countryConfig.currency}${countryConfig.coffee}, or whatever seems right. If you'd like to help this year, give whatever you like. Thank you. — The Wikimedia Foundation`;
