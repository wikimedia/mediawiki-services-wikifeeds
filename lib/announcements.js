...
const getFundraisingAnnouncementText = (countryConfig) => `To all our readers in ${countryConfig.country},<br/><br/>Please don't scroll past this. Today we humbly ask you to defend Wikipedia's independence. 98% of our readers don't give; they simply look the other way. If you are an exceptional reader who has already donated, we sincerely thank you. <b>If you donate just ${countryConfig.currency}${countryConfig.coffee},  or whatever you can today, Wikipedia could keep thriving for years.</b> Most people donate because Wikipedia is useful. If Wikipedia has given you ${countryConfig.currency}${countryConfig.coffee} worth of knowledge this year, take a minute to donate. Show the world that access to reliable, neutral information matters to you. Thank you.`;
...
const androidV2FundraisingAnnouncement = (code, countryConfig, campaign) => {
    return Object.assign({}, baseAnnouncement(campaign), {
        ...
        action: {
            title: 'DONATE NOW',
            url: `https://donate.wikimedia.org/?uselang=en&appeal=JimmyQuote&utm_medium=WikipediaApp&utm_campaign=Android&utm_source=app_2021_6C_Android_control&monthlyconvert=Default&country=${code.toUpperCase()}`
        }
    });
};
