...
const iosV3SurveyAnnouncement = (campaign) => {
    return Object.assign({}, baseAnnouncement(campaign), {
        ...
        caption_HTML: "Survey powered by a third-party<br /><a href='https://policies.google.com/privacy'>https://policies.google.com/privacy</a>",
        negative_text: 'No thanks',
        action: {
            title: 'Start survey',
            url: 'https://docs.google.com/forms/d/e/1FAIpQLSeoMkmpSHiolH5tmEdbpbtbmphXFCWqyGlqj6GBWrOHV-P1hQ/viewform?entry.366807840={{articleTitle}}'
        },
        articleTitles: [
            'Internet',
            'Chernobyl disaster',
