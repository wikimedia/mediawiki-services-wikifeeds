 ...
 */
const requestFeaturedFeedSpecialItem = (req, lang, date) => {
    const title = `Special:FeedItem/featured/${dateUtil.formatYYYYMMDD(date)}000000/${lang}`;
...
const promise = (app, req) => {
    ...
    .then((si) => requestFeaturedFeedSpecialItem(req, si.general.lang, requestedDate)
    .then((featured) => {
